...
DESCRIPTION = "Loaders and analysis of cybersecurity data."

ICON = "icons/Category-Cyber.svg"
PRIORITY = 1000
BACKGROUND = "#729FCF"
...
("{}/help/orange3-cyber/index.html".format(sysconfig.get_path("data")),
 None),
...
("http://orange3-cyber.readthedocs.io/en/latest/", "")
)
